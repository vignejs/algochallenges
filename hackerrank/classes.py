...
# Explanation
#
# Test Case 0: Because , our code must set  to  and print the "Age is not valid..." message followed by the young
# message. Three years pass and , so we print the young message again.
#
# Test Case 1: Because , our code should print that the person is young. Three years pass and , so we print that the
# person is now a teenager.
#
# Test Case 2: Because , our code should print that the person is a teenager. Three years pass and , so we print that
#  the person is old.
#
# Test Case 3: Because , our code should print that the person is old. Three years pass and the person is still old
# at , so we print the old message again.
#
