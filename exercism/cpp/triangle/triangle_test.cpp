...
TEST_CASE("degenerate_triangle")
{
    REQUIRE(triangle::flavor::degenerate == triangle::kind(2, 2, 4));
}

TEST_CASE("degenerate_triangle_2")
{
    REQUIRE(triangle::flavor::degenerate == triangle::kind(3, 4, 7));
}
